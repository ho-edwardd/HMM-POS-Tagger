...
parser.add_argument(
    ...
    dest="pred_path",
    required=True,
    help="path to your model's predicted labels file",
)
...
parser.add_argument(
    ...
    dest="dev_path",
    required=True,
    help="path to the development labels file",
)
...
if args.show_confusion:
    ...
    print("Mean F1 Score:", f1_score(data.actual, data.predicted, average="weighted"))
